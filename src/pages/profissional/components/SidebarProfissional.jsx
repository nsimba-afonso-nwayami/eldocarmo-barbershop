...
export default function SidebarProfissional({ sidebarOpen, setSidebarOpen }) {
      ...
      >
        ...
        <div className="flex-1">
          ...
          <nav className="space-y-3 text-sm">
            ...
            <Link
              to="/dashboard/profissional/notificacoes"
              className="block p-3 rounded-lg text-stone-50 hover:bg-stone-700 transition font-medium"
            >
              <i className="fas fa-bell mr-3 text-amber-400"></i>
              Notificações
            </Link>
          </nav>
        </div>
