...
export default function NotFoundProfissional() {
  return (
    <>
      <title>Página não encontrada | Dashboard Profissional</title>

      <ProfissionalLayout title="Página não encontrada">
        <main className="flex flex-col items-center justify-center min-h-[70vh] bg-stone-50 px-6 text-center py-24">
          ...
          <Link
            ...
            className="inline-block px-6 py-3 bg-amber-400 text-stone-900 font-semibold rounded-lg hover:bg-amber-500 transition cursor-pointer text-sm"
          >
