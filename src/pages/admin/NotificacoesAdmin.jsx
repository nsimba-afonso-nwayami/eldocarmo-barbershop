...
export default function NotificacoesdAdmin() {
  ...
  const notificacoes = [
    {
      ...
      tipo: "Agendamento",
      descricao:
        "Novo agendamento confirmado com Carlos Barber para 20/01/2026.",
      data: "18/01/2026",
    ...
    },
    {
      id: 2,
      tipo: "Cliente",
      descricao: "Maria Oliveira registrou-se recentemente.",
      data: "19/01/2026",
    ...
    },
    {
      id: 3,
      tipo: "Documento",
      descricao: "Relatório mensal de agendamentos disponível.",
      data: "15/01/2026",
          ...
          <div className="grid gap-4">
            ...
            <div className="flex justify-between items-center border-b border-stone-200 pb-3">
              <div>
                ...
                <p className="text-sm text-stone-500">
                  Receba alertas sobre novos clientes cadastrados
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                ...
                />
                <div
                  className={`w-11 h-6 rounded-full transition-colors ${clientes ? "bg-amber-400" : "bg-stone-200"}`}
                ></div>
                <div
                  className={`dot absolute left-1 top-1 w-4 h-4 bg-white rounded-full shadow transform transition-transform ${
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-stone-500">
                  Receba alertas sobre novos documentos ou relatórios
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                ...
                />
                <div
                  className={`w-11 h-6 rounded-full transition-colors ${documentos ? "bg-amber-400" : "bg-stone-200"}`}
                ></div>
                <div
                  className={`dot absolute left-1 top-1 w-4 h-4 bg-white rounded-full shadow transform transition-transform ${
